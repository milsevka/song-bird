 ...
 function lang() {
  choise.forEach(el => {
    ...
    if(!localStorage.getItem("lang") || (localStorage.getItem("lang") == "ru" )) {
      ...
      infotitle1.innerHTML = "Последние  исследования ученых показали, что в мире живут примерно 50 миллиардов птиц, относящихся к 9700 видам.<br> Знаешь ли ты их голоса?";
  ...
  navList[2].innerHTML = "Gallery";
      ...
      infotitle1.innerHTML = "The latest research by scientists show that there are approximately 50 billion birds belonging to 9,700 species live in the world.<br> Do you know their voices?";
  ...
  navList[2].innerHTML = "Галерэя";
      ...
      infotitle1.innerHTML = "Апошнія даследаванні навукоўцаў паказалі, што ў свеце жывуць прыкладна 50 мільярдаў птушак, якія адносяцца да 9700 відаў.<br> Ці ведаеш ты іх галасы?";
    }
  })
}
